  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>All</h4>
              <h2>Cart From Different Seller</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products call-to-action">
      <div class="container" style="max-width: 700px; margin: 0 auto;">
        🔵 To separate the payment, cart are categorized for each seller
              ...
              <?php
                ...
                while ($row = mysqli_fetch_assoc($order_result)) {
                  ...
                  <tr>
                    ...
                    <td><a href="c_orders_list_seller.php?sellerId='.$row['seller_id'].'&&sellerSName='.$row['seller_shop_name'].'" class="btn btn-info" role="button">View Product Ordered</a></td>
                  </tr>';
                }
              ?>
            </table>
