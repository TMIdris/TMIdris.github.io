              ...
              if (isset($_SESSION['name']) && isset($_SESSION['id'])) {
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="orders_notifications.php">Notifications</a>
                    <a class="dropdown-item" href="c_delivery_list.php">Delivery Details</a>
                    <a class="dropdown-item" href="orders_received_list.php">Received Orders</a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <div class="row">
                <div class="col-md-8">
                  <h4>Welcome to UniStore</h4>
                  <p>Signup is needed to make order, payment or even to be a seller!<br>
                    Choose signup if you are a new user
                  </p>
                </div>
                <div class="col-lg-4 col-md-6 text-right">
                  <a href="login.php" class="filled-button">Login</a>
                  <a href="signup.php" class="filled-button">Sign Up</a>
                </div>
              </div>
            </div>
          </div>
