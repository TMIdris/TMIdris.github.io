      ...
      <div class="container">
        ...
        <div class="inner-content">
          <div class="contact-form">
              <form name="seller" method="post" action="s_add_products_process.php" enctype="multipart/form-data">
                   <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <h4 align="left"> Product Name: </h4>
                          <fieldset>
                            <input name="name" type="text" class="form-control" id="name" placeholder="50 characters" maxlength="50" required="">
                          </fieldset>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <h4 align="left"> Product Description: </h4>
                          <fieldset>
                            <textarea name="description" type="text" class="form-control" id="description" placeholder="1000 characters" maxlength="1000" required=""></textarea>
                          </fieldset>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <fieldset>
                            <input name="stock" type="number" class="form-control" id="stock" min="1" required="">
                          </fieldset>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
