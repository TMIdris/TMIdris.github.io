        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="seller.php">Your Shop</a>
              </li> 

              <li class="nav-item active"><a class="nav-link" href="s_products.php">All Your Products</a><span class="sr-only">(current)</span></li>
