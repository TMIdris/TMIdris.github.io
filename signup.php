      ...
      <div class="container">
        <div class="inner-content">
          <div class="contact-form">
              <form name="customer" method="post" action="signup_process.php">
                   <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <fieldset>
                            <input name="email" type="text" class="form-control" id="email" placeholder="abcd.gmail.com" required="">
                          </fieldset>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <h4 align="left"> Address: </h4>
                          <fieldset>
                            <textarea name="address" type="text" class="form-control" id="address" placeholder="Home Address" required=""></textarea>
                          </fieldset>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <h4 align="left"> Phone Number: </h4>
                          <fieldset>
                            <input name="contact" type="text" class="form-control" id="contact" placeholder="Without dash and country code" required="">
                          </fieldset>
                        </div>
                    </div>
                   <div class="clearfix">
                        <button type="Reset" name="btnreset" class="filled-button pull-left">Reset</button>
                        <button type="submit" name="btnsubmit" class="filled-button pull-right">Finish</button>
                   </div>
              </form>
          </div>
        </div>
